...
This will create an executable jar file **rsl.jar** within the _target_ maven folder. This can be started by executing the following command

    java -jar target/rsl.jar
